    ...
    <div className="min-h-screen bg-gray-950 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-gray-300">Top ranked verified photos</p>
        </div>
        ...
        {/* Info box */}
        <Card variant="bordered" className="mb-6 p-4 bg-green-500/5 border-green-500/30">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-300">Only photos with verified measurements</p>
            </div>
          </div>
        </Card>
        ...
        {isLoading ? (
          ...
          <Card variant="bordered" className="text-center py-16 bg-gray-800/50 border-gray-700/50">
            ...
            <h3 className="text-2xl font-bold mb-3">No Verified Photos</h3>
            <p className="text-gray-300">No verified photos in the leaderboard yet</p>
          </Card>
        ) : (
